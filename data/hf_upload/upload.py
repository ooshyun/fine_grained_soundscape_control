"""Upload DISCO + CIPIC to ooshyun/soundscape-control-data."""
from huggingface_hub import HfApi
import argparse
from pathlib import Path


def upload(raw_dir: Path, repo_id: str = "ooshyun/soundscape-control-data"):
    api = HfApi()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--repo_id", default="ooshyun/soundscape-control-data")
